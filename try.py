...
plt.plot(x_vals, y_vals, label="Flight Path")
plt.plot(x_hill, y_hill, 'k--', label="Hill (34°)")
plt.plot(best_result["x"], best_result["y"], 'ro', label="Landing Point")
plt.title("Ski Jump Optimal Trajectory (Genetic Algorithm)")
